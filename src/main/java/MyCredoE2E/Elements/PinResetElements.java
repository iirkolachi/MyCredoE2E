...
public class PinResetElements {
    ...
    public SelenideElement otpResend = $(Selectors.byXpath("//div[@class='code disabled-block']//p[text()='კოდის თავიდან მიღება']"));
    public SelenideElement wrongOtpNotification = $(Selectors.byXpath("//p[text()='მონაცემები არასწორია']"));
    public SelenideElement closeWrongOtpNotification = $(Selectors.byXpath("//div[@class='icon white-010 close pointer']"));
